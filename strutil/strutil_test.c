...
int main() {
  ...
  for (int i = 0; tokens_ax[i]; i++) {
    free(tokens_ax[i]);
  }
  for (int i = 0; tokens_a[i]; i++) {
    free(tokens_a[i]);
  }
  for (int i = 0; tokens_b[i]; i++) {
    free(tokens_b[i]);
  }
  for (int i = 0; i < n_tokens_nax; i++) {
    free(tokens_nax[i]);
  }
  for (int i = 0; i < n_tokens_na; i++) {
    free(tokens_na[i]);
  }
  for (int i = 0; i < n_tokens_nb; i++) {
    free(tokens_nb[i]);
  }
