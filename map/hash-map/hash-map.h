...
#define hash_map_unstruct(hm)                                                  \
  ((hm)->hash), (&(hm)->size), ((void **)((hm)->buckets))

/**
 * _map_entry_unsafe_bnextp gets ptr to bnext(in type void**) from e(mostly
 * void*)
 * @param  e ptr to a map_entry_t
 * @return   ptr to bnext of e, in type void**
 */
#define _hash_map_entry_unsafe_bnextp(e) ((void **)(e))

/**
 * _map_entry_unsafe_onextp gets ptr to onext(of type void**) from e(usually
 * void*)
 * @param  e ptr to a map_entry_t
...
/**
 * _map_entry_unsafe_valuep gets ptr to value(of type void*) from e(usually
 * void*)
 * @param  e ptr to a map_entry_t
 ...
 * @return   key of a e
 */
#define hash_map_entry_key(e) ((e)->key)
 ...
 * @return   value of a e
 */
#define hash_map_entry_value(e) ((e)->value)
 ...
 * @return    size of hm
 */
#define hash_map_size(hm) ((hm)->size)
 ...
 */
#define hash_map_entrysz(hm) (sizeof(**(hm)->buckets))
 ...
 */
#define hash_map_hash(hm) ((hm)->hash)
 ...
 */
#define hash_map_contain(hm, k) (_hash_map_contain(hash_map_unstruct(hm), k))
...
#define hash_map_set(hm, k, v)                                                 \
  (_hash_map_set(hash_map_unstruct(hm), hash_map_entrysz(hm), k, &v, sizeof(v)))
...
#define hash_map_get(hm, k, pv)                                                \
  (_hash_map_get(hash_map_unstruct(hm), k, (void *)pv, sizeof(*pv)))
 ...
 */
#define hash_map_remove(hm, k) (_hash_map_remove(hash_map_unstruct(hm), k))
...
int _hash_map_contain(hash_f_t hash, int *size, void **buckets, const char *k);
int _hash_map_set(hash_f_t hash, int *size, void **buckets, int entrysz,
                  const char *k, void *v, int vsize);
int _hash_map_get(hash_f_t hash, int *size, void **buckets, const char *k,
                  void *v, int vsize);
int _hash_map_remove(hash_f_t hash, int *size, void **buckets, const char *k);
