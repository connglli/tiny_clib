...
#define list_unstruct(l)                                                       \
  ((char **)&(l)->head), ((char **)&(l)->tail), (&(l)->size),                  \
      (sizeof(*(l)->head))
 ...
 */
#define list_node_alloc(NT) ((NT *)malloc(sizeof(NT)))
 ...
 */
#define _list_node_unsafe_prevp(n) ((void **)(n))
 ...
 */
#define _list_node_unsafe_nextp(n) ((void **)((void *)(n) + sizeof(void *)))
 ...
 */
#define _list_node_unsafe_datap(n) ((void *)((void *)(n) + 2 * sizeof(void *)))
 ...
 * @return   prev of n
 */
#define list_node_prev(n) ((n)->prev)
 ...
 * @return   next of n
 */
#define list_node_next(n) ((n)->next)
 ...
 * @return   data of n
 */
#define list_node_data(n) ((n)->data)
 ...
 */
#define list_nodesz(l) (sizeof(*(l)->head))
 ...
 */
#define list_is_index_valid(l, idx) (0 <= (idx) && (idx) < (l)->size ? 1 : 0)
 ...
 * @param  n   place to put ptr to the idx-th node, must be of type
 * list_node_t**
 */
#define list_getn(l, idx, n)                                                   \
  do {                                                                         \
    if (!list_is_index_valid((l), (idx))) {                                    \
      assert(0);                                                               \
    }                                                                          \
    *(n) = (l)->head;                                                          \
    for (int _i_d_x = 0; _i_d_x != (idx);                                      \
...
#define list_appendn(l, n)                                                     \
  ((l)->size == 0                                                              \
       ? ((l)->tail = (l)->head = (n), (n)->next = (n)->prev = (n),            \
          (l)->size++)                                                         \
       : ((n)->next = (l)->head, (n)->prev = (l)->tail, (l)->tail->next = (n), \
          (l)->head->prev = (n), (l)->tail = (n), (l)->size++))
...
#define list_append(l, x)                                                      \
  (_list_unsafe_appendn(list_unstruct(l),                                      \
...
#define list_prependn(l, n)                                                    \
  ((l)->size == 0                                                              \
       ? ((l)->tail = (l)->head = (n), (n)->next = (n)->prev = (n),            \
          (l)->size++, (0))                                                    \
       : ((n)->next = (l)->head, (n)->prev = (l)->tail, (l)->tail->next = (n), \
          (l)->head->prev = (n), (l)->head = (n), (l)->size++, (0)))
...
#define list_prepend(l, x)                                                     \
  (_list_unsafe_prependn(list_unstruct(l),                                     \
                         _list_node_make(list_nodesz(l), &(x), sizeof(x))))
...
#define list_insert(l, idx, x)                                                 \
  (_list_unsafe_insertn(list_unstruct(l), (idx),                               \
                        _list_node_make(list_nodesz(l), &(x), sizeof(x))))
...
#define list_swap(l, idx1, idx2)                                               \
  (_list_swap(list_unstruct(l), list_safe_index((l), (idx1)),                  \
...
int _list_unsafe_prependn(char **head, char **tail, int *size, int nodesz,
                          void *node);
int _list_swap(char **head, char **tail, int *size, int nodesz, int idx1,
               int idx2);
